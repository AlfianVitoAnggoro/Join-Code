...
export default function CollaborationDetailPages() {
  return (
            ...
            <div className="flex flex-col space-y-2">
              ...
              <div className="mt-2">
                ...
                <div className="mt-10">
                  <a
                    href={
                      'https://mail.google.com/mail/?view=cm&fs=1&to=alfianvitoanggoro@gmail.com&su=Subjek%20EmailAja&body=Isi%20Pesanajaa'
                    }
                    target={'_blank'}

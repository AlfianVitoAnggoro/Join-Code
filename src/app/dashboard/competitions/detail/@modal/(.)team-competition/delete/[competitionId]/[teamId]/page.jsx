...
export const metadata = {
  ...
  title: 'Delete Team Competition - Join Code',
  description:
  ...
  openGraph: {
    title: 'Delete Team Competition',
    description: 'Delete Team Competition - Join Code',
    url: `${process.env.NEXT_PUBLIC_API_URL}`,
    siteName: 'Delete Team Competition',
  },
};

export default function DeleteTeamCompetitionPage({ params }) {
  return (
    <Modal>

      ...
      <div className="w-[1024px] mx-auto px-10">
        <div className="flex flex-col gap-3">
          ...
          <div className="bg-white rounded py-5 px-3">
            <h1 className="text-3xl font-bold">Competition Detail</h1>
          </div>
          {/* Card */}
                ...
                <div className="py-3">
                  ...
                  <div className="p-1 my-2 ">
                    ...
                    <p className="py-1">
                      ...
                      veniam dicta doloribus aliquid vitae, nam odit nihil cum a
                      sed ea molestias aspernatur natus laboriosam. Eos modi,
                      dicta quo veniam culpa aliquid pariatur voluptatum vel
                      omnis sapiente harum? Sint illo nulla cumque at explicabo
                      maxime rem dicta error quia odit consequuntur sunt odio
                      eaque ipsa recusandae labore provident delectus, suscipit
                      architecto, voluptatibus perspiciatis ipsam facere? Ipsum
                      unde nesciunt ut tempora possimus. Itaque, dolor.
                    </p>
                  </div>
                </div>
              </div>
